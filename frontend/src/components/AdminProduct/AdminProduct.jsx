...
const AdminProduct = () => {
    ...
    return (
      <div>
        ...
        <DeleteOutlined
          ...
          style={{ color: "#bd3d3dd4", fontSize: "30px", cursor: "pointer" }}
        />
      </div>
    );
  };
  const columns = [
    ...
    },
    {
      ...
      onFilter: (value, record) => {
        switch (value) {
          case "1":
            return record.type === "Điện thoại";
          case "2":
            return record.type === "Laptop";
          case "3":
            return record.type === "Tablet";
          case "4":
            return record.type === "Phụ kiện";
          case "5":
            return record.type === "Smartwatch";
          case "6":
            return record.type === "Đồng hồ";
          case "7":
            return record.type === "Máy cũ giá rẻ";
          case "8":
            return record.type === "PC, Máy in";
          case "9":
            return record.type === "Sim, thẻ cào";
          case "10":
            return record.type === "Dịch vụ tiện ích";
          default:
            break;
        }
      },
  ...
  useEffect(() => {
    if (isSuccessDeleted && dataDeleted?.status === "OK") {
      ...
      message.error(dataDeleted?.message) || message.error();
    }
